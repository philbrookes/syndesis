...
func createConnection(connection *api.Connection, apiHost string) error {
	...
	req.Header.Set("X-FORWARDED-ACCESS-TOKEN", "eyJhbGciOiJSUzI1NiIsImtpZCI6IiJ9..GaQ9nm10FqHyWejViLjEcYOKjj3YNMkH82SPxQ6i88vW70ULMZxtLellkfyOQSNyDf9F23mFz8cdZpoHJXhnPIfm17FrgzqvgkjowleDrP0HUZt4xiQIn8_nBD4ttXLivLP9zdpXRUcHi2R1-F8fe6LguTRHtOPR9MW-vprR1xw9fCUcBBeYwrcDEo6pAUeZQ8tN0HgN5AbolT-4wXBwrv6CQpkkEE94jq3DMb36wZTNh0sBWAhAuuPX9VwF4hZp9b7wwAi3OkMIEHaw0pJEK_BnmqjuaCq8Ko66FZFSF8LrsSbApD85bpND8nEmHFIArtkgoovQ4iaU7Yvyrtg6fw")
...
func getBody(username, password, url, connectionName string) *bytes.Buffer {
	populatedBody := strings.Replace(body, "<<<CONNECTION_URL>>>", url, 1)
